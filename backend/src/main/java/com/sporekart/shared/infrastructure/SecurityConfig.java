    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
        http
            ...
            .authorizeHttpRequests(auth -> auth
                ...
                .requestMatchers(HttpMethod.POST, "/orders", "/api/v1/orders", "/orders/", "/api/v1/orders/").permitAll()
                .requestMatchers(HttpMethod.GET, "/orders/*", "/api/v1/orders/*", "/orders/number/*", "/api/v1/orders/number/*").permitAll()
                .requestMatchers(HttpMethod.POST, "/payment/initiate", "/api/v1/payment/initiate", "/payment/verify", "/api/v1/payment/verify", "/payment/webhook", "/api/v1/payment/webhook", "/payment/verify-enrollment", "/api/v1/payment/verify-enrollment").permitAll()
                .requestMatchers(HttpMethod.GET, "/payment/summary", "/api/v1/payment/summary").permitAll()
                .requestMatchers(HttpMethod.POST, "/analytics/track-*", "/api/v1/analytics/track-*").permitAll()
