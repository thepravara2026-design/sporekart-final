  ...
  return (
    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8 space-y-12 animate-fade-in">
      ...
      <div className="space-y-4 max-w-3xl">
        <span className="px-3.5 py-1 rounded-full bg-spore-950 border border-spore-700/50 text-spore-300 text-xs font-semibold shadow-inner">
      ...
      <section className="grid grid-cols-1 md:grid-cols-3 gap-6">
        <div className="glass-panel p-6 rounded-3xl border border-spore-700/50 space-y-3 hover-lift">
          ...
          <div className="flex items-center justify-between text-xs font-bold pt-2 border-t border-slate-800">
            <Link to="/blog" className="text-spore-300 hover:underline">Cultivation Guide</Link>
        ...
        <div className="glass-panel p-6 rounded-3xl border border-spore-700/50 space-y-3 hover-lift">
          ...
          <div className="flex items-center justify-between text-xs font-bold pt-2 border-t border-slate-800">
            <Link to="/blog" className="text-spore-300 hover:underline">Spawn Guide</Link>
            <span className="text-slate-600">➔</span>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
        {BLOG_POSTS.map((post) => (
          <article
            key={post.id}
            className="glass-card p-6 rounded-3xl border border-spore-800/60 flex flex-col justify-between space-y-4 hover:border-spore-500/50 transition-all group hover-lift"
          >
            <div className="space-y-3">
              <div className="flex items-center justify-between text-[11px] text-slate-400">
                <span className="px-2.5 py-1 rounded-xl bg-slate-900 border border-slate-800 text-spore-400 font-semibold">
                  {post.category}
                </span>
                <span className="flex items-center gap-1">
                  <Clock className="w-3 h-3 text-spore-400" /> {post.readTime}
                </span>
              </div>
            ...
            {post.targetIntent && (
              <div className="p-3 rounded-2xl bg-slate-950/80 border border-spore-800/60 space-y-2 text-xs">
                ...
                <Link
                  ...
                  className="w-full py-1.5 px-3 bg-spore-900/60 hover:bg-spore-800 text-spore-300 font-bold rounded-xl border border-spore-700/50 flex items-center justify-between text-[11px] transition-all button-press"
                >
